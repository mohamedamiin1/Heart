...
heart_disease_model = pickle.load(open('C:/Users/Administrator/Desktop/Heast/heart_disease_model.sav', 'rb'))
...
if selected == 'Home':
    ...
    with open("C:\\Users\\Administrator\\Desktop\\Heart\\heartbeating1.gif", "rb") as file:
        contents = file.read()
...
df = pd.read_csv('C:/Users/Administrator/Desktop/Heart/heart.csv')
df = df.dropna()
...
if selected == 'About Us':
    ...
    with col1:
        image = Image.open ('C:/Users/Administrator/Desktop/Heart/me.png')
        st.image(image, caption="Mohamed Abdiwahab Mohamed.")
    with col2:
        image = Image.open ('C:/Users/Administrator/Desktop/Heart/osman.png')
        st.image(image, caption="Osman Hassan Mohamud.")
    st.write("---")
    st.subheader("Supervisor")
    col1, col2 = st.columns(2)
    with col1:
        image = Image.open ('C:/Users/Administrator/Desktop/Heart/ustad.png')
